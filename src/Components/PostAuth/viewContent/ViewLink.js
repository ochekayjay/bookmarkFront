...
const back = <svg xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 96 960 960" width="40" fill='#FFFFFF'><path d="M480 896 160 576l320-320 47 46.666-240.001 240.001H800v66.666H286.999L527 849.334 480 896Z"/></svg>
  ...
  return (
    <div className='ViewLinkMain'>
        ...
        <div style={{width:'100%',boxSizing:'border-box',display:'flex',flexDirection:'column',justifyContent:'space-around',height:width>700?'70%':'55%',color:'white',overflow:"auto",backgroundColor:'#0d47a1',position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',padding:'20px'}}>
