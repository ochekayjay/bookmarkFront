        ...
        <div className="folderaddMain" >
              <div style={{width:'300px',height:'300px',borderRadius:'14px',boxShadow: '0px 0px 15px #0b1f36',backgroundColor:'#0d47a1',position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',paddingTop:'40px'}}>
                  ...
                  <div style={{display:'flex',justifyContent:'space-around'}}>
                      <p onClick={()=>{setFolderLoad(false);setfolderSelector(false)}} style={{fontSize:'40px',cursor:'pointer',color:'white',height:'55px',width:'55px',boxShadow: '0px 0px 15px #0b1f36',display:'flex',alignItems:'center',borderRadius:'50%',justifyContent:'center',margin:'25px auto'}}>{cancelIcon}</p>
