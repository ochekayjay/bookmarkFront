...
import { GetFolderImage } from './AddFolderSections/ImageSection/ImageEndpoints'
  ...
  setTextArray([])
    ...
    <div style={{display:'flex',justifyContent:'space-between',position:'absolute',bottom:'0px',left:'0px',boxSizing:'border-box',height:'70%',borderRadius:'20px 20px 0px 0px',boxShadow: '0px 0px 15px #0b1f36',width:'100%'}}>
                ...
                <div style={{width:'33.3%',height:'100%',overflow:'auto'}}>
                    ...
                    <div style={{width:"100%",padding:'15px',boxSizing:"border-box",display:'flex',flexDirection:"column",alignItems:"center"}}>
                  {ImageArray.map(imgObj => <div style={{width:'95%',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:"column",height:"auto",padding:"15px",boxSizing:"border-box",boxShadow: '0px 0px 15px #0b1f36',backgroundColor:"#0d47a1",color:"white",margin:"10px 0px",borderRadius:"15px"}}>
                    <p style={{textAlign:"left",fontFamily:"NexaTextBold",marginBottom:"10px"}}>{imgObj.title}</p>
                  
                    <p style={{textAlign:"left",}}>{imgObj.source}</p>
                    <img src={imgObj.path} style={{width:"85%",margin:'15px auto',borderRadius:'15px',height:"150px",objectFit:"cover"}}/>
                  </div>)}
                </div>
                </div>
      </div>
