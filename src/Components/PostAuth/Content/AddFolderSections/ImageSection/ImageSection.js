...
export function ImageSection({setaddItemToShow,ImageArray,setImageArray}) {
  ...
  const createImage = async(event)=>{
      ...
      console.log(imgjson)
      if(imgjson){
        setImageArray([...ImageArray, imgjson])
